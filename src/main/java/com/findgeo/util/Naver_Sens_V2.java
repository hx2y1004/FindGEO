...
//        String accessKey = "M5FLRqhIbBAF0xmRkQ8t";                     	// 개인 인증키
//        String secretKey = "MOsGSWRJ2olUTLXHbETfnPH3PXxO4AGtKcB1tVSr";  // 2차 인증을 위해 서비스마다 할당되는 service secret
//        String serviceId = "ncp:sms:kr:296927627552:findgeo";        	// 프로젝트에 할당된 SMS 서비스 ID
...
//
//	    toJson.put("content","찾아Geo 인증번호는 ["+rand+"]입니다.");		// 난수와 함께 전송
//	    toJson.put("to",phone);
//	    toArr.add(toJson);
//	    
//	    bodyJson.put("type","sms");			// 메시지 Type (sms | lms)
//	    bodyJson.put("contentType","COMM"); //메시지 타입 (COMM | AD)
