...
public class BoardController {
	...
	// @GetMapping("/board/boardlist")
	// public String board(Model model, @RequestParam(required=false, defaultValue =
	// "0", value="page") int page ) {
	// Page<Posts> listPage = postService.list(page);
	...
	// System.out.println(listPage.getContent().get(totalPage).getEmail()+"여기는 이메일
	// 자르고 뒤에 * 찍기위함 여기는 보드컨트롤러 ");
